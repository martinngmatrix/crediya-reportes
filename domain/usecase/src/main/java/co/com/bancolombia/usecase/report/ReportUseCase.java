...
public class ReportUseCase {
    ...
    public Mono<Report> getApprovedLoansApplicationsReport() {
        return reportRepository.getEntityBySomeKeys(Constants.APPROVED_STATUS)
    ...
    public Mono<Void> updateLoansApplicationReport(BigDecimal amount) {
        return reportRepository.updateApprovedLoansApplicationsReport(Constants.APPROVED_STATUS, amount);
    }
}
